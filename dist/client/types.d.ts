import type { HttpRouter, GenericActionCtx, GenericMutationCtx, GenericQueryCtx, GenericDataModel } from "convex/server";
/**
 ...
 */
export type DownloadAuthCallback = (ctx: HttpActionCtx, blobId: string, path?: string, extraParams?: Record<string, string>) => Promise<boolean>;
export type { BunnyStorageConfig, TestStorageConfig, StorageConfig, } from "../blobstore/index.js";
